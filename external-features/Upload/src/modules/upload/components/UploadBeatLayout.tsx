...
export function UploadBeatLayout() {
  ...
  const handleGoToMyBeats = () => {
    ...
    console.log('Would navigate to /my-beats');
    // navigate('/my-beats'); // Removed for standalone package
  };
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={() => {
                ...
                // navigate('/dashboard'); // Removed for standalone package
              }}
            >
              {t('upload.actions.goToDashboard')}
            </Button>
