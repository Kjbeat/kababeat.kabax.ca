...
export interface IPlaylistService {
  ...
  getPlaylistTracks(playlistId: string): Promise<any[]>; // Returns populated beat data
...
// Playlist controller interfaces
...
export interface PlaylistWithTracks extends IPlaylist {
  tracks: any[]; // Populated beat data
}
...
export interface FrontendPlaylist {
  ...
  isFeatured: boolean;
  isCurated: boolean;
  tracks?: any[]; // Populated when needed
}
